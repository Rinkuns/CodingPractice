...
public class Docs {
	static int DistinctYears(String str) {
		String str2="";
	...
	public static void main(String[] args) {
		String str="Soon after the world war 2 ended on 02-09-1945. The UN was established on 24-10-1945. The 1948. then in 1949";
		System.out.println(DistinctYears(str));
	}
}
